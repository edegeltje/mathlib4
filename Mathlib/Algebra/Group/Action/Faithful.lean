...
instance (R : Type*) [Mul R] [IsRightCancelMul R] : FaithfulSMul R R :=
  ⟨fun {r₁ r₂} h ↦ by simpa using h r₁⟩
...
instance (R : Type*) [Mul R] [IsLeftCancelMul R] : FaithfulSMul Rᵐᵒᵖ R :=
  ⟨fun {r₁ r₂} h ↦ by simpa using h r₁.unop⟩
...
@[to_additive (attr :=
    deprecated "subsumbed by `instFaithfulSMulMulOpposite` or \
